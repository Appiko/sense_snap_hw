...
F 1 "2.2uH" V 9199 1150 50  0000 C CNN
...
F 1 "1M" H 10720 1905 50  0000 L CNN
...
Text HLabel 10350 3050 0    50   Input ~ 0
PWR2
Text HLabel 9200 3050 0    50   Input ~ 0
PWR1
Text HLabel 7750 1550 0    50   Input ~ 0
REG_EN
...
F 3 "~" H 7900 1800 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text HLabel 10650 1150 2    50   Input ~ 0
VLED
...
VDD
Text HLabel 3700 6100 2    50   Input ~ 0
RX_EN
Text HLabel 2200 5600 2    50   Input ~ 0
RX_OUT
...
F 0 "R5" H 6670 3646 50  0000 L CNN
F 1 "NC" H 6670 3555 50  0000 L CNN
F 2 "sense_fp:C_0402_1005Metric" V 6530 3600 50  0001 C CNN
...
F 0 "R4" V 7000 3250 50  0000 L CNN
F 1 "470E" V 6900 3200 50  0000 L CNN
F 2 "sense_fp:C_0402_1005Metric" V 6830 3300 50  0001 C CNN
...
F 0 "#PWR041" H 6600 3550 50  0001 C CNN
...
Trigger the volume down button\nwhen connected to mobiles
Text Notes 9100 4450 0    60   ~ 0
Change the feedback voltage such that the\nIR LED voltage changes. This is to control \nthe emitted power of the LED.
Wire Wire Line
	7050 3300 7200 3300
Wire Wire Line
	5850 3300 6600 3300
